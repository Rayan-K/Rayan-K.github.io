    ...
    fetch('http://127.0.0.1:5500/FinalTask/js/data.json')
    ...
    .then(function(res) {
      ...
      res.json().then(function(json) {
        ...
        json.teeshirt.forEach(function(el) {
   ...
   /* const test = document.querySelector('.menu_precise').addEventListener('click',function(){
      console.log('test');
    })*/
